...
public class ClientUDP extends JFrame {
    ...
    public ClientUDP() {
        ...
        try { // create DatagramSocket for sending and receiving packets
            // Note that the DatagramSocket constructor call does not specify any arguments. 
            // This no-argument constructor allows the computer
            // to select the next available port number for the DatagramSocket .
